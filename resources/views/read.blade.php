...
<div class="card-header">{{ $other_memo[0]['user_name']}}さんのメモ内容</div>
    ...
    <div class="m-3 scroll-overflow-read border-top border-bottom">
        {{ $other_memo[0]['content'] }}
    </div>

    <div class="scroll-overflow-tag">登録タグ:
        @foreach($tags as $tag)
